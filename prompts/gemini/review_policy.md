...
Esta é uma revisão headless baseada exclusivamente no dossier fornecido. O orquestrador já coletou diff, commits, regras, resultados dos gates locais e CI para o HEAD indicado. Não execute comandos, terminal, shell, Git, testes, consultas de rede ou ferramentas de leitura/escrita de arquivos. Não solicite permissões nem crie arquivos de plano. Use somente o mecanismo de resposta estruturada disponibilizado pela CLI para concluir a resposta conforme o schema solicitado.
